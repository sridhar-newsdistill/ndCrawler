...
public class TextBlock implements Cloneable {
  ...
  public TextBlock(final String text,final String html, final BitSet containedTextElements, final int numWords,
	      final int numWordsInAnchorText, final int numWordsInWrappedLines, final int numWrappedLines,
	      final int offsetBlocks)
	      {
	  this(text,containedTextElements,numWords,numWordsInAnchorText,numWordsInWrappedLines,numWrappedLines,offsetBlocks);
